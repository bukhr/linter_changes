...
class Shoulda::Context::Context
  ...
  # @return [Boolean]
  #
  # source://shoulda-context//lib/shoulda/context/context.rb#104
  def am_subcontext?; end

  # source://shoulda-context//lib/shoulda/context/context.rb#201
  def build; end

  # source://shoulda-context//lib/shoulda/context/context.rb#153
  def build_test_name_from(should); end

  # source://shoulda-context//lib/shoulda/context/context.rb#47
  def context(name, &blk); end

  # source://shoulda-context//lib/shoulda/context/context.rb#118
  def create_test_from_should_hash(should); end

  # source://shoulda-context//lib/shoulda/context/context.rb#99
  def full_name; end

  # source://shoulda-context//lib/shoulda/context/context.rb#38
  def merge_block(&blk); end

  # source://shoulda-context//lib/shoulda/context/context.rb#219
  ...
  # source://shoulda-context//lib/shoulda/context/context.rb#194
  def print_should_eventuallys; end

  # source://shoulda-context//lib/shoulda/context/context.rb#162
  def run_all_setup_blocks(binding); end

  # source://shoulda-context//lib/shoulda/context/context.rb#182
  ...
  # source://shoulda-context//lib/shoulda/context/context.rb#167
  ...
  # source://shoulda-context//lib/shoulda/context/context.rb#68
  def should(name_or_matcher, options = T.unsafe(nil), source_location = T.unsafe(nil), &blk); end

  # source://shoulda-context//lib/shoulda/context/context.rb#91
  ...
  def should_not(matcher, source_location = T.unsafe(nil)); end
  ...
  # source://shoulda-context//lib/shoulda/context/context.rb#95
  ...
  # source://shoulda-context//lib/shoulda/context/context.rb#112
  def test_methods; end

  # source://shoulda-context//lib/shoulda/context/context.rb#211
  def test_name_prefix; end

  # source://shoulda-context//lib/shoulda/context/context.rb#108
  def test_unit_class; end
end

# source://shoulda-context//lib/shoulda/context/context.rb#59
class Shoulda::Context::Context::LambdaWithLocation < ::Proc
  # @return [LambdaWithLocation] a new instance of LambdaWithLocation
  #
  # source://shoulda-context//lib/shoulda/context/context.rb#62
  def initialize(source_location, &blk); end

  # Returns the value of attribute source_location.
  #
  # source://shoulda-context//lib/shoulda/context/context.rb#60
...
module Shoulda::Context::DSL::ClassMethods
  ...
  #  end
  #
  # source://shoulda-context//lib/shoulda/context/dsl.rb#123
  ...
  #
  # source://shoulda-context//lib/shoulda/context/dsl.rb#190
  def context(name, &blk); end
  ...
  #   # => User
  #
  # source://shoulda-context//lib/shoulda/context/dsl.rb#203
  ...
  #
  # source://shoulda-context//lib/shoulda/context/dsl.rb#128
  ...
  #
  # source://shoulda-context//lib/shoulda/context/dsl.rb#84
  def should_not(matcher, source_location = T.unsafe(nil)); end
  ...
  #   end
  #
  # source://shoulda-context//lib/shoulda/context/dsl.rb#220
  def subject(&block); end

  # source://shoulda-context//lib/shoulda/context/dsl.rb#224
  def subject_block; end
end

# source://shoulda-context//lib/shoulda/context/dsl.rb#229
module Shoulda::Context::DSL::InstanceMethods
  # source://shoulda-context//lib/shoulda/context/dsl.rb#257
  def get_instance_of(object_or_klass); end

  # source://shoulda-context//lib/shoulda/context/dsl.rb#265
  ...
  # being tested.
  #
  # source://shoulda-context//lib/shoulda/context/dsl.rb#249
  def subject; end

  # source://shoulda-context//lib/shoulda/context/dsl.rb#253
  def subject_block; end

  private

  # source://shoulda-context//lib/shoulda/context/dsl.rb#271
  def construct_subject; end
end

# source://shoulda-context//lib/shoulda/context/context.rb#224
